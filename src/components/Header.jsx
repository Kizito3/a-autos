...
// };
//   return (
//     <div className='bg-white shadow-2xl py-2 px-4 sticky z-40 border-b'>
...
//                   Top deals
//                 </li>
//                 <li className='btn2 nav1 mt-2'>
//                   Sign in 
//                 </li>
//                 <li className='btn1 py-2 px-4 nav1 text-white rounded'>
//                   Sign up 
//                 </li>
//             </ul>
//             <div className="block lg:hidden">
//         <button className="flex items-center px-3 py-2 border rounded text-gray-200 border-gray-400 hover:text-white hover:border-white" onClick={handleToggleMenu}>
